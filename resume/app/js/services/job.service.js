  ...
  angular.module('job.service', [
    ...
    .service('jobService', function($log, jobFactory, constantsService) {
      ...
      this.generateJobData = function() {
        ...
        arr.push(new jobFactory('Raytheon Company', '10/2017', null, 'Tucson, AZ', 'Senior Software Engineer', null, [constantsService['responsibility.raytheon.sse.1'], constantsService['responsibility.raytheon.sse.2'], constantsService['responsibility.raytheon.sse.3']]));
