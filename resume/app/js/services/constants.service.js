  ...
  angular.module('constants.service', [])
    .service('constantsService', function($log) {
      ...
      let constants = {
        ...
        'responsibility.raytheon.sse.2': 'Utilize Spring Framework, AngularJS, Selenium, UI-Bootstrap, and Bootstrap to develop responsive web applications',
        'responsibility.raytheon.sse.3': 'Project teams used SAFe Agile project management methodology to execute all projects',
